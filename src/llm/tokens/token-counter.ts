...
export function countTokens(
  ...
  try {
    ...
    console.warn(
      'Tiktoken failed, falling back to character approximation:',
      error
    );
...
export function calculateTokenCost(
  ...
  const inputTokens =
    tokenUsage.userTokens + tokenUsage.systemTokens + tokenUsage.toolTokens;
 ...
 */
export function isContextWindowCritical(
  totalTokens: number,
  modelName: string
): boolean {
