...
describe('Tool Integration', () => {
  ...
  it('should handle structured tool calls and results', async () => {
    ...
    expect(response.content).toBe(
      'I found the following files: file1.txt, file2.txt, and a directory.'
    );
    ...
    const toolResultMsg = secondCallMessages.find((msg: any) =>
      msg.content.includes('["file1.txt","file2.txt","directory1"]')
    );
