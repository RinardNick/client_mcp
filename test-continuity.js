// Simple test script to verify tool continuation
// Usage: node test-continuity.js

import { SessionManager } from './dist/llm/session.js';
import dotenv from 'dotenv';

dotenv.config();

async function testContinuity() {
  // For testing purposes - we'll override any env variable to proceed with test
